...
static CGFloat const kAwesomeMenuDefaultEndRadius = 90.0f;
static CGFloat const kAwesomeMenuDefaultFarRadius = 140.0f;
static CGFloat const kAwesomeMenuDefaultStartPointX = 30.0;

static  CGFloat const kAwesomeMenuDefaultStartPointY = 430;
...
- (id)initWithFrame:(CGRect)frame startItem:(AwesomeMenuItem*)startItem optionMenus:(NSArray *)aMenusArray
{
    ...
    if (self) {
		...
		self.startPoint = CGPointMake(kAwesomeMenuDefaultStartPointX, ScreenHeight - 30);
